    ...
    $(document).on("focus", ".mat-input", function() {
      ...
      $.ajax({
        ...
        success: function(result) {
          //$('.bigImg img.active').removeClass('active').siblings('img').addClass('active');
          // $('.bigImg img.active').fadeOut(300).delay(310).attr('src', imgurl).fadeIn();
          $('.bigImg img.active').fadeOut(100).delay(200).attr('src', imgurl).fadeIn();

...
Class Model_Base {
    ...
    private $dataResult;
     ...
     public function __construct($servername = "localhost", $username = "ubuntumysql", $password = "amazonAWS", $dbname = "db_leonamunro") {
     //public function __construct($servername = "localhost", $username = "Leonamunro", $password = "Vipers11!!", $dbname = "db_leonamunro") {
     // public function __construct($servername = "localhost", $username = "root", $password = "", $dbname = "db_leonamunro") {
    ...
    public static function connectdb($servername = "localhost", $username = "ubuntumysql", $password = "amazonAWS", $dbname = "db_leonamunro") {
    //public static function connectdb($servername = "localhost", $username = "Leonamunro", $password = "Vipers11!!", $dbname = "db_leonamunro") {

    // public static function connectdb($servername = "localhost", $username = "root", $password = "", $dbname = "db_leonamunro") {

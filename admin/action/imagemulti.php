        ...
        if ($_FILES["files"]["error"][$i] > 0) {
            ...
            if($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg" && $imageFileType != "gif" ) {
              ...
              # print_r(error_get_last());
                ...
                data-resize='".$_FILES["files"]["name"][$i]."' width='50' height='50' class='locationImgView'/><a href='#' class='removeImg' data-imgname='<?php echo $i; ?>'><span class='far fa-trash-alt'></span> </a></div>";
